// server/board-data.js — Monopoly Revolution Official 75th Anniversary Edition Data
...
const BOARD_SPACES = [
    ...
    { id: 5, name: "WALKING ZONE CHANCE", type: "ZONE_SPACE", zone: "WALKING", color: "#00D4FF", price: 0, rent: [0], houseCost: 0, mortgage: 0 },
    { id: 6, name: "Reading Railroad", type: "RAILROAD", zone: "WALKING", group: "RAILROAD", color: COLOR_GROUPS.RAILROAD, price: 200, rent: [25, 50, 100, 200], houseCost: 0, mortgage: 100 },
    { id: 7, name: "Oriental Ave", type: "PROPERTY", zone: "WALKING", group: "LIGHT_BLUE", color: COLOR_GROUPS.LIGHT_BLUE, price: 100, rent: [6, 30, 90, 270, 400, 550], houseCost: 50, mortgage: 50 },
    ...
    { id: 15, name: "CYCLE ZONE CHANCE", type: "ZONE_SPACE", zone: "CYCLE", color: "#00E87B", price: 0, rent: [0], houseCost: 0, mortgage: 0 },
    { id: 16, name: "Pennsylvania RR", type: "RAILROAD", zone: "CYCLE", group: "RAILROAD", color: COLOR_GROUPS.RAILROAD, price: 200, rent: [25, 50, 100, 200], houseCost: 0, mortgage: 100 },
    { id: 17, name: "St. James Place", type: "PROPERTY", zone: "CYCLE", group: "ORANGE", color: COLOR_GROUPS.ORANGE, price: 180, rent: [14, 70, 200, 550, 750, 950], houseCost: 100, mortgage: 90 },
    ...
    { id: 22, name: "Indiana Ave", type: "PROPERTY", zone: "CAR", group: "RED", color: COLOR_GROUPS.RED, price: 220, rent: [18, 90, 250, 700, 875, 1050], houseCost: 150, mortgage: 110 },
    { id: 23, name: "Illinois Ave", type: "PROPERTY", zone: "CAR", group: "RED", color: COLOR_GROUPS.RED, price: 240, rent: [20, 100, 300, 750, 925, 1100], houseCost: 150, mortgage: 120 },
    { id: 24, name: "B. & O. Railroad", type: "RAILROAD", zone: "CAR", group: "RAILROAD", color: COLOR_GROUPS.RAILROAD, price: 200, rent: [25, 50, 100, 200], houseCost: 0, mortgage: 100 },
    { id: 25, name: "CAR ZONE CHANCE", type: "ZONE_SPACE", zone: "CAR", color: "#FFD700", price: 0, rent: [0], houseCost: 0, mortgage: 0 },
    ...
    { id: 33, name: "Pennsylvania Ave", type: "PROPERTY", zone: "ROCKET", group: "GREEN", color: COLOR_GROUPS.GREEN, price: 320, rent: [28, 150, 450, 1000, 1200, 1400], houseCost: 200, mortgage: 160 },
    { id: 34, name: "Gas Works", type: "UTILITY", zone: "ROCKET", group: "UTILITY", color: COLOR_GROUPS.UTILITY, price: 150, rent: [4, 10], houseCost: 0, mortgage: 75 },
    { id: 35, name: "ROCKET ZONE CHANCE", type: "ZONE_SPACE", zone: "ROCKET", color: "#FF2D7B", price: 0, rent: [0], houseCost: 0, mortgage: 0 },
    { id: 36, name: "Solar Energy", type: "UTILITY", zone: "ROCKET", group: "UTILITY", color: COLOR_GROUPS.UTILITY, price: 150, rent: [4, 10], houseCost: 0, mortgage: 75 },
    { id: 37, name: "Short Line RR", type: "RAILROAD", zone: "ROCKET", group: "RAILROAD", color: COLOR_GROUPS.RAILROAD, price: 200, rent: [25, 50, 100, 200], houseCost: 0, mortgage: 100 },
    { id: 38, name: "Park Place", type: "PROPERTY", zone: "ROCKET", group: "DARK_BLUE", color: COLOR_GROUPS.DARK_BLUE, price: 350, rent: [35, 175, 500, 1100, 1300, 1500], houseCost: 200, mortgage: 175 },
...
const ZONE_EVENTS = [
    { text: "ZONE INSPECTION: All players in this zone pay $50 fine!", action: "ZONE_PAY", amount: 50 },
    { text: "SPEED BONUS: All players in this zone receive $100 bonus!", action: "ZONE_GAIN", amount: 100 },
    { text: "ZONE LOCKDOWN: All players in this zone are sent to JAIL!", action: "ZONE_JAIL" },
...
const CHANCE_CARDS = [
    ...
    { text: "Advance to Illinois Ave", action: "MOVE_TO", target: 23, collectGo: true },
